...
document
  ...
  .addEventListener("click", VerifyLoginCredentials);
document.getElementById("resumePage").style.display = "none";

//Converted data
const data = candidatesData.resume;
let loadedData = 0;
let searchPosition = "";
...
function VerifyLoginCredentials() {
  ...
  if (username === "" || password === "") {
    document.getElementById("InvalidInformation").innerText =
...
function AddOtherTabsInPage() {
  ...
  document
    ...
    .addEventListener("change", SearchBasedOnJobDescription);

  //Event for Next and Previous Button
  document
    .getElementById("previousButton")
    .addEventListener("click", loadPreviousData);
...
function loadData(i) {
  ...
  document.getElementById("appliedFor").innerText =
    "Applied For : " + candidate.basics.AppliedFor;
  ...
  document.getElementById("profile").innerText =
    candidate.basics.profiles.network;
  concatenateData = "";
  ...
  document.getElementById("companyName").innerHTML =
    "<b>Company Name : </b>" + candidate.work.CompanyName;
  document.getElementById("position").innerHTML =
    "<b>Position : </b>" + candidate.work.Position;
  document.getElementById("startDate").innerHTML =
    "<b>Start Date : </b>" + candidate.work.StartDate;
  document.getElementById("endDate").innerHTML =
    "<b>End Date : </b>" + candidate.work.EndDate;
  document.getElementById("summary").innerHTML =
    "<b>Summary : </b>" + candidate.work.Summary;
  ...
  document.getElementById("project").innerHTML =
    ...
    " : </b>" +
    candidate.projects.description;

  //Education
  document.getElementById("ugEducation").innerHTML =
    "<b>UG: </b>" +
    candidate.education.UG.institute +
    ", " +
    candidate.education.UG.course +
    ", " +
    candidate.education.UG.StartDate +
    ", " +
    candidate.education.UG.EndDate +
    ", " +
    candidate.education.UG.cgpa;
  document.getElementById("puEducation").innerHTML =
    "<b>PU: </b>" +
    candidate.education.SeniorSecondary.institute +
    ", " +
    candidate.education.SeniorSecondary.cgpa;
  document.getElementById("hsEducation").innerHTML =
    "<b>High School: </b>" +
    candidate.education.HighSchool.institute +
    ", " +
    candidate.education.HighSchool.cgpa;

  //Internship
  document.getElementById("internCompanyName").innerHTML =
    "<b>Company Name : </b>" + candidate.Internship.CompanyName;
  document.getElementById("internPosition").innerHTML =
    "<b>Position : </b>" + candidate.Internship.Position;
  document.getElementById("internStartDate").innerHTML =
    "<b>Start Date : </b>" + candidate.Internship.StartDate;
  document.getElementById("internEndDate").innerHTML =
    "<b>End Date : </b>" + candidate.Internship.EndDate;
  document.getElementById("internSummary").innerHTML =
    "<b>Summary : </b>" + candidate.Internship.Summary;

  //Achievments
  concatenateData = "";
  candidate.achievements.Summary.forEach(prepareBulletedPoints);
  document.getElementById("allAchievements").innerHTML = concatenateData;
}
...
function GetDataBasedOnPosition(data) {
  ...
  if (position.includes(searchPosition.toLowerCase())) return data;
}
